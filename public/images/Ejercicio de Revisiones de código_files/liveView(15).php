...
var SekindoClientDetections_URL = function (config) {
	...
	this.setInfo();
				...
				var urlDetObj = new SekindoClientDetections_URL({
					url: 'https://live.primis.tech/live/liveView.php?s=110171&schain=1.0,1!theadengine.com,[1345],1&cbuster=1647312244',
					origQString: 's=110171&schain=1.0,1!theadengine.com,[1345],1',
					placementId: 110171,
					x: 600,
					y: 400,
					videoType: 'flow',
